...
filterBkpStep.profileCGH <- function(profileCGH, MinBkpWeight=0.35, DelBkpInAmp=TRUE, assignGNLOut=TRUE, verbose=FALSE, ...)
  {
        ...
        while (fin!=1)
          {
            ...
            profileCGH <- filterBkp(profileCGH, MinBkpWeight=MinBkpWeight, DelBkpInAmp=DelBkpInAmp)
