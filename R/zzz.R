...
#    if(!require(aws))stop("You must install the package named aws")
    ...
    print("or the HaarSeg algorithm (Ben-Yaacov and Eldar, Bioinformatics,  2008)")
    print("")
    print("If you use the package with AWS, please cite:")
    print("Hupe et al. (Bioinformatics, 2004) and Polzehl and Spokoiny (2002)")
    print("")    
    print("If you use the package with HaarSeg, please cite:")
    print("Hupe et al. (Bioinformatics, 2004) and (Ben-Yaacov and Eldar, Bioinformatics, 2008)")
    print("")
